...
public class Supermarket {
  ...
  public void printInfoNewCustomer(Date date, Customer customer) {
    String str = Utils.getInfoTime(date) + "New customer '" + customer.getName() + "' arrived; category - " +
            customer.getCustomerCategory().name() + "; cash - " +
            Utils.roundingNumber(customer.getCash()) + "; bank card - " +
            Utils.roundingNumber(customer.getBankCard()) + "; bonus - " +
            Utils.roundingNumber(customer.getBonus());
