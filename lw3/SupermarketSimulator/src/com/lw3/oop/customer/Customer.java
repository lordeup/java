package com.lw3.oop.customer;

import com.lw3.oop.customer.basket.Basket;
import com.lw3.oop.customer.customercategory.CustomerCategory;
import com.lw3.oop.customer.paymentmethod.PaymentMethod;
import com.lw3.oop.product.Product;
import com.lw3.oop.product.producttype.ProductType;
import com.lw3.oop.product.typeproductsale.TypeProductSale;
...
public class Customer {
  ...
  private BigDecimal getTypeProductSalePrice(Product product, Integer quantityGoods, BigDecimal price) {
    ...
    } else if (product.getTypeProductSale() == TypeProductSale.BY_WEIGHT) {
